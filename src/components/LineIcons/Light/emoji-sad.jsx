...
function EmojiSad(props) {
	const title = props.title || "emoji sad";
	...
	<g fill="#000000">
		...
		<path d="M32 38.9c-5.5 0-10.7 2-14.8 5.8-.6.6-.6 1.5-.1 2.1.6.6 1.5.6 2.1.1 3.5-3.2 8-5 12.7-5 4.7 0 9.3 1.8 12.7 5 .3.3.7.4 1 .4.4 0 .8-.2 1.1-.5.6-.6.5-1.6-.1-2.1-3.8-3.8-9.1-5.8-14.6-5.8z"/>
