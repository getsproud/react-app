...
function ArrowMinimize(props) {
	...
	<title>{title}</title>
	<g fill="#000000">
		<path d="M33.7 35.8c-1-.8-2.4-.8-3.4 0l-4.4 3.9c-.6.5-.7 1.5-.1 2.1s1.5.7 2.1.1l2.7-2.3v22.9c0 .8.7 1.5 1.5 1.5s1.5-.7 1.5-1.5V39.6l2.7 2.3c.3.2.6.4 1 .4s.8-.2 1.1-.5c.5-.6.5-1.6-.1-2.1l-4.6-3.9z"/>
