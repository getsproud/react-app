...
function TruckChecked(props) {
	const title = props.title || "truck checked";
	...
	<g fill="#000000">
		...
		<path d="M20.9 18.2c.6-.7.5-1.8-.2-2.5-.7-.6-1.8-.5-2.5.2l-3.7 4.4-1.7-1.7c-.7-.7-1.8-.7-2.5 0s-.7 1.8 0 2.5l3.1 3.1c.3.3.8.5 1.2.5h.1c.5 0 1-.2 1.3-.6l4.9-5.9z"/>
	</g>
</svg>
	);
};

export default TruckChecked;