...
function Box8(props) {
	...
	<g fill="#000000">
		...
		<path d="M43.9 43.2H51c1 0 1.8-.8 1.8-1.8s-.8-1.8-1.8-1.8h-7.1c-1 0-1.8.8-1.8 1.8s.8 1.8 1.8 1.8z"/>
		<path d="M52.5 47.6h-10c-1 0-1.8.8-1.8 1.8s.8 1.8 1.8 1.8h10c1 0 1.8-.8 1.8-1.8s-.9-1.8-1.8-1.8z"/>
	</g>
</svg>
	);
};
