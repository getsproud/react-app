...
function TruckUpArrow(props) {
	const title = props.title || "truck up arrow";
	...
	<g fill="#000000">
		...
		<path d="M18.2 21.7c.7.7 1.8.7 2.5 0s.7-1.8 0-2.5L16.4 15c-.7-.7-1.8-.7-2.5 0l-4.4 4.4c-.7.7-.7 1.8 0 2.5.3.3.8.5 1.2.5s.9-.2 1.2-.5l3.1-3.1 3.2 2.9z"/>
	</g>
</svg>
	);
};

export default TruckUpArrow;