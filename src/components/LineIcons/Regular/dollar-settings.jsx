...
function DollarSettings(props) {
	const title = props.title || "dollar settings";

	return (
		<svg height="64" width="64" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
	<title>{title}</title>
	<g fill="#000000">
		<path d="M30.2 25.6h7.6c1 0 1.8-.8 1.8-1.8s-.8-1.8-1.8-1.8h-2.9v-1.7c0-1-.8-1.8-1.8-1.8s-1.8.8-1.8 1.8V22h-1.2c-3.2 0-5.8 2.6-5.8 5.8 0 3.2 2.6 5.8 5.8 5.8h3.5c1.3 0 2.3 1 2.3 2.3s-1 2.3-2.3 2.3H26c-1 0-1.8.8-1.8 1.8s.8 1.8 1.8 1.8h5.3v1.7c0 1 .8 1.8 1.8 1.8s1.8-.8 1.8-1.8v-1.8c2.7-.5 4.7-2.9 4.7-5.7 0-3.2-2.6-5.8-5.8-5.8h-3.5c-1.3 0-2.3-1-2.3-2.3s1-2.3 2.2-2.3z"/>
