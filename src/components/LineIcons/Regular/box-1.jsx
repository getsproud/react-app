...
function Box1(props) {
	const title = props.title || "box 1";

	return (
		<svg height="64" width="64" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
	<title>{title}</title>
	<g fill="#000000">
		<path d="M50.1 46.6l-1.4 1.5v-7.7c0-1-.8-1.8-1.8-1.8s-1.8.8-1.8 1.8v7.7l-1.4-1.5c-.7-.7-1.8-.7-2.5-.1-.7.7-.7 1.8-.1 2.5l4.4 4.7c.3.4.8.6 1.3.6s.9-.2 1.3-.6l4.4-4.7c.7-.7.6-1.8-.1-2.5-.5-.7-1.6-.6-2.3.1z"/>
