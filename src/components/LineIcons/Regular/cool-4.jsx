...
function Cool4(props) {
	const title = props.title || "cool 4";
	...
	<g fill="#000000">
		...
		<path d="M38.4 36.9c-.7-.7-1.8-.7-2.5 0l-3.9 4-3.9-3.9c-.7-.7-1.8-.7-2.5 0s-.7 1.8 0 2.5l3.9 3.9-3.9 3.9c-.7.7-.7 1.8 0 2.5.3.3.8.5 1.2.5s.9-.2 1.2-.5l3.9-3.9 3.9 3.9c.3.3.8.5 1.2.5s.9-.2 1.2-.5c.7-.7.7-1.8 0-2.5l-3.9-3.9 3.9-3.9c.9-.8.9-1.9.2-2.6z"/>
	</g>
</svg>
	);
};

export default Cool4;