...
function PhoneRing(props) {
	...
	<g fill="#000000">
		...
		<path d="M37.3 6.1c10.8.7 19.7 9.3 20.6 20.1.1.9.8 1.6 1.7 1.6h.1c1-.1 1.7-.9 1.6-1.9C60.3 13.4 50 3.4 37.5 2.6c-.9-.1-1.8.7-1.9 1.6 0 1 .7 1.8 1.7 1.9z"/>
		<path d="M36.4 16c5.9.7 10.4 5.3 11.1 11.2.1.9.9 1.6 1.7 1.6h.2c1-.1 1.7-1 1.5-1.9-.8-7.5-6.7-13.4-14.2-14.2-1-.1-1.8.6-1.9 1.5 0 .8.7 1.7 1.6 1.8z"/>
	</g>
</svg>
	);
};
