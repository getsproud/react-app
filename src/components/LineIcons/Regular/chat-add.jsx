...
function ChatAdd(props) {
	...
	<g fill="#000000">
		...
		<path d="M39.1 27.6h-5.4v-5.4c0-1-.8-1.8-1.8-1.8s-1.8.8-1.8 1.8v5.4h-5.4c-1 0-1.8.8-1.8 1.8s.8 1.8 1.8 1.8h5.4v5.4c0 1 .8 1.8 1.8 1.8s1.8-.8 1.8-1.8v-5.4h5.4c1 0 1.8-.8 1.8-1.8s-.8-1.8-1.8-1.8z"/>
	</g>
</svg>
	);
};
