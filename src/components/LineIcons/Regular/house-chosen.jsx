...
function HouseChosen(props) {
	const title = props.title || "house chosen";

	return (
		<svg height="64" width="64" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
	<title>{title}</title>
	<g fill="#000000">
		<path d="M49.2 40.8L46 44.5l-1.5-1.6c-.7-.7-1.8-.7-2.5-.1-.7.7-.7 1.8-.1 2.5l2.9 3c.3.3.8.5 1.3.5s1-.2 1.3-.6l4.5-5.2c.6-.7.5-1.8-.2-2.5-.8-.6-1.9-.5-2.5.3z"/>
