...
function HouseDiscount(props) {
	const title = props.title || "house discount";

	return (
		<svg height="64" width="64" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
	<title>{title}</title>
	<g fill="#000000">
		<path d="M52.1 38.4c-.7-.7-1.8-.7-2.5 0l-8.3 8.3c-.7.7-.7 1.8 0 2.5.3.3.8.5 1.2.5s.9-.2 1.2-.5l8.3-8.3c.7-.7.7-1.8.1-2.5z"/>
		<path d="M44.4 41.5c1.1-1.1 1.1-3 0-4.1-1.1-1.1-3-1.1-4.1 0s-1.1 3 0 4.1c1.1 1.2 3 1.2 4.1 0z"/>
		<path d="M49 46.1c-1.1 1.1-1.1 3 0 4.1 1.1 1.1 3 1.1 4.1 0s1.1-3 0-4.1c-1.1-1.1-3-1.1-4.1 0z"/>
