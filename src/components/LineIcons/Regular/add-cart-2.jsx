...
function AddCart2(props) {
	const title = props.title || "add cart 2";
	...
	<g fill="#000000">
		...
		<path d="M22.3 11.3l2-2V22c0 1 .8 1.8 1.8 1.8s1.8-.8 1.8-1.8V9.2l2 2c.3.3.8.5 1.2.5s.9-.2 1.2-.5c.7-.7.7-1.8 0-2.5l-5-5c-.7-.7-1.8-.7-2.5 0l-5 5c-.7.7-.7 1.8 0 2.5.7.8 1.8.8 2.5.1z"/>
	</g>
</svg>
	);
};
