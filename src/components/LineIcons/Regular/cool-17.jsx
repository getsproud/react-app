...
function Cool17(props) {
	const title = props.title || "cool 17";

	return (
		<svg height="64" width="64" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
	<title>{title}</title>
	<g fill="#000000">
		<path d="M43.5 36.3c-1 0-1.8.8-1.8 1.8v1.5c0 1.3-1.1 2.4-2.4 2.4H24.6c-1.3 0-2.4-1.1-2.4-2.4V38c0-1-.8-1.8-1.8-1.8s-1.6.8-1.6 1.8v1.5c0 3.2 2.6 5.9 5.9 5.9h14.7c3.2 0 5.9-2.6 5.9-5.9V38c-.1-1-.9-1.7-1.8-1.7z"/>
