...
function Cool10(props) {
	const title = props.title || "cool 10";
	...
	<g fill="#000000">
		...
		<path d="M32 39.4c-5.4 0-10.5 2-14.4 5.6-.7.7-.7 1.8-.1 2.5.7.7 1.8.7 2.5.1 3.3-3 7.5-4.7 12-4.7s8.7 1.7 12 4.7c.3.3.8.5 1.2.5.5 0 .9-.2 1.3-.6.7-.7.6-1.8-.1-2.5-3.9-3.6-9-5.6-14.4-5.6z"/>
