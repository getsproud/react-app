...
function PhoneOutgoing(props) {
	...
	<title>{title}</title>
	<g fill="#000000">
		<path d="M44.5 11.9l5.9-5.6v19.8c0 1 .8 1.8 1.8 1.8s1.8-.8 1.8-1.8V6.3l5.9 5.6c.3.3.8.5 1.2.5.5 0 .9-.2 1.3-.5.7-.7.6-1.8-.1-2.5l-7.4-7.1c-1.4-1.4-3.7-1.4-5.1 0l-7.4 7.1c-.7.7-.7 1.8-.1 2.5.4.6 1.5.7 2.2 0z"/>
