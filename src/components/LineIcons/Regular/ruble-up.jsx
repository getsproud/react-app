...
function RubleUp(props) {
	const title = props.title || "ruble up";
	...
	<g fill="#000000">
		...
		<path d="M36.3 22.8c2.9 0 5.3-2.4 5.3-5.3s-2.4-5.3-5.3-5.3h-6.1c-1 0-1.8.8-1.8 1.8v12.6H24c-1 0-1.8.8-1.8 1.8s.8 1.8 1.8 1.8h4.4v4.3c0 1 .8 1.8 1.8 1.8s1.8-.8 1.8-1.8V30h4.4c1 0 1.8-.8 1.8-1.8s-.8-1.8-1.8-1.8H32v-3.7h4.3zM32 15.7h4.3c1 0 1.8.8 1.8 1.8s-.8 1.8-1.8 1.8H32v-3.6z"/>
	</g>
</svg>
	);
};

export default RubleUp;