...
function Cash(props) {
	...
	<g fill="#000000">
		...
		<path d="M39.9 35.4c4.9 0 8.8-4 8.8-8.9s-4-8.8-8.8-8.8-8.9 4-8.9 8.8c.1 4.9 4 8.9 8.9 8.9zm0-14.2c3 0 5.3 2.4 5.3 5.3 0 3-2.4 5.4-5.3 5.4s-5.4-2.4-5.4-5.4c.1-2.9 2.5-5.3 5.4-5.3z"/>
	</g>
</svg>
	);
};
