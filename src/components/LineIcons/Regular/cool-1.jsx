...
function Cool1(props) {
	...
	<g fill="#000000">
		...
		<path d="M44 44c-3.3 3-7.5 4.7-12 4.7S23.3 47 20 44c-.7-.7-1.8-.6-2.5.1s-.6 1.8.1 2.5c3.9 3.6 9 5.6 14.4 5.6s10.5-2 14.4-5.6c.7-.7.7-1.8.1-2.5-.7-.7-1.8-.8-2.5-.1z"/>
