...
function PhoneIncoming(props) {
	...
	<title>{title}</title>
	<g fill="#000000">
		<path d="M49.5 26.9c.7.7 1.6 1 2.6 1 .9 0 1.8-.3 2.6-1l7.4-7.1c.7-.7.7-1.8.1-2.5-.7-.7-1.8-.7-2.5-.1l-5.9 5.6V3c0-1-.8-1.8-1.8-1.8S50.3 2 50.3 3v19.8l-5.9-5.6c-.7-.7-1.8-.6-2.5.1s-.6 1.8.1 2.5l7.5 7.1z"/>
