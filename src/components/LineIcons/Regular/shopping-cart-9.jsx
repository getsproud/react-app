...
function ShoppingCart9(props) {
	const title = props.title || "shopping cart 9";

	return (
		<svg height="64" width="64" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
	<title>{title}</title>
	<g fill="#000000">
		<path d="M19.3 31.3H37c1 0 1.8-.8 1.8-1.8V19.3c0-1-.8-1.8-1.8-1.8h-2v-3.4c0-3.7-3-6.8-6.8-6.8-1.6 0-3.1.5-4.3 1.5-.7.6-.9 1.7-.2 2.5.6.7 1.7.9 2.5.2.6-.5 1.3-.7 2.1-.7 1.8 0 3.3 1.5 3.3 3.3v3.4H19.3c-1 0-1.8.8-1.8 1.8v10.3c.1 1 .9 1.7 1.8 1.7zm1.8-10.2h14.1v6.8H21.1v-6.8z"/>
