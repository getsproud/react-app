...
function MessageCross(props) {
	...
	<title>{title}</title>
	<g fill="#000000">
		<path d="M60.4 39.5c-.7-.7-1.8-.7-2.5 0l-4.3 4.3-4.3-4.3c-.7-.7-1.8-.7-2.5 0s-.7 1.8 0 2.5l4.3 4.3-4.3 4.3c-.7.7-.7 1.8 0 2.5.3.3.8.5 1.2.5s.9-.2 1.2-.5l4.3-4.3 4.3 4.3c.3.3.8.5 1.2.5s.9-.2 1.2-.5c.7-.7.7-1.8 0-2.5l-4.3-4.3 4.3-4.3c.9-.7.9-1.8.2-2.5z"/>
