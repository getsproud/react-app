...
function HalfBattery(props) {
	...
	<g fill="#000000">
		...
		<path d="M12.9 25.3c-1 0-1.8.8-1.8 1.8V37c0 1 .8 1.8 1.8 1.8s1.8-.8 1.8-1.8V27c0-.9-.8-1.7-1.8-1.7z"/>
		<path d="M22.9 25.3c-1 0-1.8.8-1.8 1.8V37c0 1 .8 1.8 1.8 1.8s1.8-.8 1.8-1.8V27c-.1-.9-.8-1.7-1.8-1.7z"/>
	</g>
</svg>
	);
};
