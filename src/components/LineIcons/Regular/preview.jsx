...
function Preview(props) {
	...
	<title>{title}</title>
	<g fill="#000000">
		<path d="M32 24.2c-8.7 0-14.5 6.4-14.8 6.7-.5.5-.6 1.3-.3 2 .1.3 3.8 7 15 7 10.6 0 14.8-6.6 15-6.9.4-.6.3-1.4-.1-2-.2-.3-5.3-6.8-14.8-6.8zm0 12.1c-6.6 0-9.8-2.6-11.2-4.1 1.8-1.6 5.9-4.5 11.2-4.5 5.7 0 9.5 2.9 11.2 4.4-1.5 1.5-4.9 4.2-11.2 4.2z"/>
