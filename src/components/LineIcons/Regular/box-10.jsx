...
function Box10(props) {
	const title = props.title || "box 10";

	return (
		<svg height="64" width="64" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
	<title>{title}</title>
	<g fill="#000000">
		<path d="M50.1 41.9l-4.7 4.9-1.6-1.8c-.7-.7-1.8-.8-2.5-.1-.7.7-.8 1.8-.1 2.5l2.9 3.1c.3.4.8.6 1.3.6s.9-.2 1.3-.5l6-6.3c.7-.7.6-1.8-.1-2.5s-1.8-.7-2.5.1z"/>
