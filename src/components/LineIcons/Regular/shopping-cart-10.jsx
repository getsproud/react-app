...
function ShoppingCart10(props) {
	const title = props.title || "shopping cart 10";
	...
	<g fill="#000000">
		...
		<path d="M19.3 31.3H37c1 0 1.8-.8 1.8-1.8V19.2c0-1-.8-1.8-1.8-1.8h-2V14c0-3.7-3-6.8-6.8-6.8s-6.8 3-6.8 6.8v3.4h-2.1c-1 0-1.8.8-1.8 1.8v10.3c.1 1 .9 1.8 1.8 1.8zm5.6-17.2c0-1.8 1.5-3.3 3.3-3.3 1.8 0 3.3 1.5 3.3 3.3v3.4H25v-3.4zM21.1 21h14.1v6.8H21.1V21z"/>
	</g>
</svg>
	);
};

export default ShoppingCart10;