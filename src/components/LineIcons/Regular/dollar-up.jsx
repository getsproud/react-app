...
function DollarUp(props) {
	...
	<title>{title}</title>
	<g fill="#000000">
		<path d="M32 10.7c-1 0-1.8.8-1.8 1.8v.4H30c-3.1 0-5.6 2.7-5.6 6s2.5 6 5.6 6h4c1.2 0 2.1 1.1 2.1 2.5s-1 2.5-2.1 2.5h-6.2c-1 0-1.8.8-1.8 1.8s.8 1.8 1.8 1.8h2.5v.4c0 1 .8 1.8 1.8 1.8s1.8-.8 1.8-1.8v-.4h.1c3.1 0 5.6-2.7 5.6-6s-2.5-6-5.6-6h-4c-1.2 0-2.1-1.1-2.1-2.5s1-2.5 2.1-2.5h6.3c1 0 1.8-.8 1.8-1.8s-.8-1.8-1.8-1.8h-2.5v-.4c-.1-1.1-.8-1.8-1.8-1.8z"/>
