...
function BoxAdd(props) {
	const title = props.title || "box add";

	return (
		<svg height="64" width="64" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
	<title>{title}</title>
	<g fill="#000000">
		<path d="M51.4 44h-2.7v-2.7c0-1-.8-1.8-1.8-1.8s-1.8.8-1.8 1.8V44h-2.7c-1 0-1.8.8-1.8 1.8s.8 1.8 1.8 1.8h2.7v2.7c0 1 .8 1.8 1.8 1.8s1.8-.8 1.8-1.8v-2.7h2.7c1 0 1.8-.8 1.8-1.8s-.9-1.8-1.8-1.8z"/>
